...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> userLocationExceptionHandler(UserLocationException e, WebRequest webRequest) {
        ErrorDetails errorDetail = new ErrorDetails(e.getMessage(), webRequest.getDescription(false));
        return new ResponseEntity<>(errorDetail, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorDetails> exceptionHandler(ProjectException e, WebRequest webRequest) {
        ErrorDetails errorDetail = new ErrorDetails(e.getMessage(), webRequest.getDescription(false));
        return new ResponseEntity<>(errorDetail, HttpStatus.BAD_REQUEST);
    }
